...
<script>
  $(document).ready(function(){
    ...
    var markalar=["İstanbul","İzmir","Ankara","Antalya"];
    var calisma=["85","25","30","70"];
    var chartdata={
    labels:markalar,
    datasets:[
    {
...
<script>
  $(document).ready(function(){
    ...
    var markalar=["İstanbul","İzmir","Ankara","Antalya"];
    var calisma=["90","55","15","85"];
    var chartdata={
    labels:markalar,
    datasets:[
    {
    label:'Ulaşım Kolaylığı',
    data:calisma,
    options:chartOptions,
    backgroundColor: ["#e8c3b9","#c45850","#ffdf00","#53adfc"]
    }]
